...
public class Call {
  ...
  public static synchronized void transferItemEffect(Item item, float x, float y, Itemsc to) {
    if(mindustry.Vars.net.server() || !mindustry.Vars.net.active()) {
  ...
  public static synchronized void transferItemToUnit(Item item, float x, float y, Itemsc to) {
    if(mindustry.Vars.net.server() || !mindustry.Vars.net.active()) {
