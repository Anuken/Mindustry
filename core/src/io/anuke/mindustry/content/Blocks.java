...
public class Blocks implements ContentList{
    ...
    blackstone, dirt, sand, ice, snow, grass, shrub, rock, icerock, blackrock, smelter, arcsmelter, siliconsmelter,
    plastaniumCompressor, phaseWeaver, alloySmelter, pyratiteMixer, blastMixer, cryofluidmixer, melter, separator,
    centrifuge, biomatterCompressor, pulverizer, solidifier, incinerator, powerVoid, powerSource, itemSource, liquidSource,
    itemVoid, copperWall, copperWallLarge, denseAlloyWall, denseAlloyWallLarge, thoriumWall, thoriumWallLarge, door, doorLarge,
