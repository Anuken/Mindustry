...
/*
        Array<Mission> missions = Array.with(
            ...
            //TODO fix positions
            new ConditionMission(Bundles.get("text.mission.linknode"), () -> world.tile(54, 52).entity != null && world.tile(54, 52).entity.power != null && world.tile(54, 52).entity.power.getAmount() >= 0.01f)
