...
public class ArmoredConveyor extends Conveyor{
    ...
    public boolean blends(Tile tile, int rotation, int otherx, int othery, int otherrot, Block otherblock){
        ...
        || ((!otherblock.rotate && Edges.getFacingEdge(otherblock, otherx, othery, tile) != null &&
                (Edges.getFacingEdge(otherblock, otherx, othery, tile).relativeTo(tile) == tile.rotation()) || otherblock instanceof Conveyor) || Point2.equals(otherx + Geometry.d4(otherrot).x, othery + Geometry.d4(otherrot).y, tile.x, tile.y)));
    }
}
