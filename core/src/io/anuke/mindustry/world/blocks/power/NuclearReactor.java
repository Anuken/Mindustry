...
public class NuclearReactor extends PowerGenerator{
    ...
    public void setBars(){
        super.setBars();
        bars.replace(new BlockBar(BarType.inventory, true, new BlockBar.Value(tile -> tile.entity.items.get(consumes.item()), tile -> itemCapacity)));
        bars.replace(new BlockBar(BarType.inventory, true, new BlockBar.Value(tile -> tile.<NuclearReactorEntity>entity().heat, tile -> 1f)));
    }
