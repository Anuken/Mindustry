...
public class LaunchPad extends StorageBlock{
    ...
    public void update(Tile tile){
        ...
        if(entity.enabled() && world.isZone() && entity.cons.valid() && world.isZone() && entity.items.total() >= itemCapacity && entity.timer.get(timerLaunch, launchTime / entity.timeScale)){
