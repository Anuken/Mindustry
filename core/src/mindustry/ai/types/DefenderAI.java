...
public class DefenderAI extends AIController{
    ...
    public Teamc findTarget(float x, float y, float range, boolean air, boolean ground){
        ...
        var result = Units.closest(unit.team, x, y, Math.max(range, 400f), u -> !u.dead() && u.type != unit.type && u.type.defendable && u.targetable(unit.team), (u, tx, ty) -> -u.maxHealth + Mathf.dst2(u.x, u.y, tx, ty) / 6400f);
