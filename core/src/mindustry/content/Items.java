...
public class Items implements ContentList{
    ...
    sporePod, sand, blastCompound, pyratite, metaglass, powercell, lithium;
    ...
    public void load(){
        ...
        powercell = new Item("powercell", Color.valueOf("d3d604")){{
            explosiveness = 0.2f;
            radioactivity = 0.5f;
            cost = 1.0f;
        }};

        lithium = new Item("lithium", Color.valueOf("c9c9c9")){{
            radioactivity = 0.25f;
            cost = 0.5f;
        }};
