...
public class SerpuloTechTree{
    ...
    public static void load(){
        Planets.serpulo.techTree = nodeRoot("serpulo", coreShard, () -> {
            ...
            node(conveyor, () -> node(junction, () -> node(router, () -> {
                node(advancedLaunchPad, Seq.with(new SectorComplete(extractionOutpost)), () -> node(landingPad, () -> node(interplanetaryAccelerator, Seq.with(new SectorComplete(planetaryTerminal)), () -> {
                ...
                node(sorter, () -> {
                    node(invertedSorter);
                    node(overflowGate, () -> node(underflowGate));
                });
                ...
                node(itemBridge, () -> node(titaniumConveyor, Seq.with(new SectorComplete(craters)), () -> {
                    node(phaseConveyor, () -> node(massDriver, () -> {

                    }));

                    node(payloadConveyor, () -> node(payloadRouter, () -> {

                    }));

                    node(armoredConveyor, () -> node(plastaniumConveyor, () -> {

                    }));
                }));
            })));

            node(coreFoundation, () -> node(coreNucleus, () -> {

            }));

            node(mechanicalDrill, () -> {

                node(mechanicalPump, () -> node(conduit, () -> node(liquidJunction, () -> node(liquidRouter, () -> {
                    node(liquidContainer, () -> node(liquidTank));
                    ...
                    node(pulseConduit, Seq.with(new SectorComplete(windsweptIslands)), () -> {
                        ...
                        node(rotaryPump, () -> node(impulsePump, () -> {
                ...
                node(graphitePress, () -> {
                    node(pneumaticDrill, Seq.with(new SectorComplete(frozenForest)), () -> {
                        ...
                        node(laserDrill, () -> {
                            ...
                            node(waterExtractor, Seq.with(new SectorComplete(saltFlats)), () -> node(oilExtractor, () -> {

                            }));
                        });
                    });

                    node(pyratiteMixer, () -> node(blastMixer, Seq.with(new SectorComplete(facility32m)), () -> {
                    ...
                    node(siliconSmelter, () -> {
                        ...
                        node(sporePress, () -> {
                            node(coalCentrifuge, () -> node(multiPress, () -> node(siliconCrucible, () -> {

                            })));

                            node(plastaniumCompressor, Seq.with(new SectorComplete(windsweptIslands), new OnSector(tarFields)), () -> node(phaseWeaver, Seq.with(new SectorComplete(tarFields)), () -> {

                            }));
                        });

                        node(kiln, Seq.with(new SectorComplete(craters)), () -> node(pulverizer, () -> node(incinerator, () -> node(melter, () -> {
                            node(surgeSmelter, () -> {

                            });

                            node(separator, () -> node(disassembler, () -> {
                        ...
                        node(microProcessor, () -> node(switchBlock, () -> {
                            node(message, () -> {
                                node(logicDisplay, () -> node(largeLogicDisplay, () -> {

                                }));

                                node(memoryCell, () -> node(memoryBank, () -> {

                                }));
                            });

                            node(logicProcessor, () -> node(hyperProcessor, () -> {
                ...
                node(combustionGenerator, Seq.with(new Research(Items.coal)), () -> node(powerNode, () -> {
                    ...
                    node(mender, () -> node(mendProjector, () -> {
                        node(forceProjector, Seq.with(new SectorComplete(impact0078)), () -> node(overdriveProjector, Seq.with(new SectorComplete(impact0078)), () -> node(overdriveDome, Seq.with(new SectorComplete(impact0078)), () -> {

                        })));

                        node(repairPoint, () -> node(repairTurret, () -> {

                        }));
                    }));

                    node(steamGenerator, Seq.with(new SectorComplete(craters)), () -> node(thermalGenerator, () -> node(differentialGenerator, () -> node(thoriumReactor, Seq.with(new Research(Liquids.cryofluid)), () -> {
                        node(impactReactor, () -> {
            ...
            node(duo, () -> {
                node(copperWall, () -> node(copperWallLarge, () -> {
                    node(scrapWall, () -> node(scrapWallLarge, () -> node(scrapWallHuge, () -> node(scrapWallGigantic))));
                ...
                node(scatter, () -> node(hail, Seq.with(new SectorComplete(craters)), () -> node(salvo, () -> {
                    node(swarmer, () -> node(cyclone, () -> node(spectre, Seq.with(new SectorComplete(nuclearComplex)), () -> {
            ...
            node(groundFactory, () -> {
                ...
                node(dagger, () -> {
                    ...
                    node(nova, () -> node(pulsar, () -> node(quasar, () -> node(vela, () -> node(corvus, () -> {

                    })))));

                    //override research requirements to have graphite, not coal
                    node(crawler, ItemStack.with(Items.silicon, 400, Items.graphite, 400), () -> node(atrax, () -> node(spiroct, () -> node(arkyid, () -> node(toxopid, Seq.with(new SectorComplete(mycelialBastion)), () -> {
                ...
                node(airFactory, () -> {
                    node(flare, () -> {
                        node(horizon, () -> node(zenith, () -> node(antumbra, () -> node(eclipse, () -> {

                        }))));

                        node(mono, () -> node(poly, () -> node(mega, () -> node(quad, () -> node(oct, () -> {

                        })))));
                    });

                    node(navalFactory, Seq.with(new OnSector(windsweptIslands)), () -> node(risso, () -> {
                        node(minke, () -> node(bryde, () -> node(sei, () -> node(omura, () -> {

                        }))));

                        node(retusa, Seq.with(new SectorComplete(windsweptIslands)), () -> node(oxynoe, Seq.with(new SectorComplete(coastline)), () -> node(cyerce, () -> node(aegires, () -> node(navanax, Seq.with(new SectorComplete(navalFortress)), () -> {
            ...
            node(groundZero, () -> node(frozenForest, Seq.with(
            ...
            nodeProduce(Items.copper, () -> {
                ...
                nodeProduce(Items.sand, () -> {
                    nodeProduce(Items.scrap, () -> nodeProduce(Liquids.slag, () -> {

                    }));

                    nodeProduce(Items.coal, () -> {
                        nodeProduce(Items.graphite, () -> nodeProduce(Items.silicon, () -> {

                        }));

                        nodeProduce(Items.pyratite, () -> nodeProduce(Items.blastCompound, () -> {
                        ...
                        nodeProduce(Liquids.oil, () -> nodeProduce(Items.plastanium, () -> {
