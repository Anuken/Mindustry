...
public class MapContentView implements AssetView{
    ...
    public void build(MapAssetsDialog diag, Table list){
        ...
        for(var content : contents){
            ...
            list.button(content.content instanceof UnlockableContent u && (u.uiIcon != null && u.uiIcon.found() || u.fullIcon != null && u.fullIcon.found()) ? new TextureRegionDrawable(u.uiIcon != null && u.uiIcon.found() ? u.uiIcon : u.fullIcon) :
