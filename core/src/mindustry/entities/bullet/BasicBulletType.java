...
public class BasicBulletType extends BulletType{
    ...
    public void draw(Bulletc b){
        ...
        float drawRot = (b.time() + b.id()) * spin;

        Draw.color(backColor);
        Draw.rect(backRegion, b.x(), b.y(), width, height, b.rotation() - 90 + drawRot);
        Draw.color(frontColor);
        Draw.rect(frontRegion, b.x(), b.y(), width, height, b.rotation() - 90 + drawRot);
        Draw.color();
    }
}
