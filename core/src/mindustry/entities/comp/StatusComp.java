...
abstract class StatusComp implements Posc{
    ...
    transient float speedMultiplier = 1, damageMultiplier = 1, healthMultiplier = 1, reloadMultiplier = 1, buildSpeedMultiplier = 1, dragMultiplier = 1, armorOverride = -1f, rotateSpeedMultiplier = 1, weaponRotateMultiplier = 1;
    ...
    /** Uses a dynamic status effect to change weapon rotation speed. */
    public void statusWeaponRotateMultiplier(float weaponRotateMultiplier){
        applyDynamicStatus().weaponRotateMultiplier = weaponRotateMultiplier;
    }
    ...
    public void update(){
        ...
        applied.clear();
        armorOverride = -1f;
        speedMultiplier = damageMultiplier = healthMultiplier = reloadMultiplier = buildSpeedMultiplier = dragMultiplier = rotateSpeedMultiplier = weaponRotateMultiplier = 1f;
        disarmed = false;
        ...
        while(index < statuses.size){
            ...
            if(entry.effect == null || (entry.time <= 0 && !entry.effect.permanent)){
                ...
                if(entry.effect.dynamic){
                    ...
                    weaponRotateMultiplier *= entry.weaponRotateMultiplier;
                    ...
                    weaponRotateMultiplier *= entry.effect.weaponRotateMultiplier;
