...
public class Drawf{
    ...
    public static void construct(Building t, UnlockableContent content, Color color, float rotation, float progress, float speed, float time){
        construct(t, content.icon(Cicon.full), color, rotation, progress, speed, time);
    }
    ...
    public static void construct(Building t, UnlockableContent content, float rotation, float progress, float speed, float time){
        construct(t, content, Pal.accent, rotation, progress, speed, time);
    }
