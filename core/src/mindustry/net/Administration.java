...
public class Administration{
    ...
    public static class Config{
        ...
        maxMessageLength = new Config("maxMessageLength", "The maximum length of a chat message sent by a player.", maxTextLength, () -> Call.setMaxTextLength(Config.maxMessageLength.num())),
