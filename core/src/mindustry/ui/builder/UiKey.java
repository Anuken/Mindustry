...
public enum UiKey{
    ...
    text, wrap, region, icon, scaling, background, margin, id, hint, maxLength, checked, min, max, step, defaultValue, clicked, style, group, condition,
    ...
    align, colspan, uniform, uniformX, uniformY;
