    ...
    public void runHost(){
        ...
        Time.runTask(5f, () -> {
            try{
                ...
                if(steam){
                    Core.app.post(() -> Core.settings.getBoolOnce("steampublic3", () -> ui.showCustomConfirm("@setting.publichost.name", "@public.confirm", "@yes", "@no", () -> ui.showCustomConfirm("@setting.publichost.name", "@public.confirm.really", "@no", "@yes", () -> {
