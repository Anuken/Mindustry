...
public class Block extends UnlockableContent implements Senseable{
    ...
    public void createIcons(MultiPacker packer){
        ...
        generatePalettedTeamRegions(packer); //generate paletted team regions
    ...
    private void generatePalettedTeamRegions(MultiPacker packer) {
        if(teamRegion != null && teamRegion.found()){
            processTeamRegion(packer);
            teamRegions = new TextureRegion[Team.all.length];
            for(Team team : Team.all){
                teamRegions[team.id] = teamRegion.found() && team.hasPalette ? Core.atlas.find(name + "-team-" + team.name, teamRegion) : teamRegion;
            }
    ...
    private void processTeamRegion(MultiPacker packer) {
        for(Team team : Team.all){
    ...
    private static void setPixmapRegion(Team team, PixmapRegion base, Pixmap out) {
