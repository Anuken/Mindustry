                ...
                if(following != null){
                    ...
                    for(int i = 0; i < blocks.size; i++){
                        ...
                        if(within(block.x * tilesize, block.y * tilesize, range)){
                            ...
                            if(Build.validPlace(btype, unit.team(), block.x, block.y, block.rotation) && (state.rules.infiniteResources || team.items().has(btype.requirements, state.rules.buildCostMultiplier))){
