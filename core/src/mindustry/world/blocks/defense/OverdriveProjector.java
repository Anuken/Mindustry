    ...
    public void drawPlace(int x, int y, int rotation, boolean valid){
        ...
        if(hasBoost && boosterUnlocked) {
            ...
            for(int i = 0; i < 360; i += 60){
                ...
                Drawf.arrow(x * tilesize + offset + close.x, y * tilesize + offset + close.y, x * tilesize + offset + far.x, y * tilesize + offset + far.y, phaseRangeBoost/2 + sin, 4f + sin, phaseColor);
            }
