...
public class NodeLogicBlock extends AcceptorLogicBlock{
    ...
    public int signal(Tile tile){
        NodeLogicEntity entity = tile.ent();
        if(linkValid(tile)){
    ...
    public void update(Tile tile){
        ...
        if(linkValid(tile, link)){
            NodeLogicEntity other = link.ent();
    ...
    public boolean linkValid(Tile tile, Tile other){
        return other != null && other.entity != null && other.block() instanceof NodeLogicBlock
            ...
            && (other.getTeam() == tile.getTeam() || !(tile.entity instanceof LogicEntity)) && (other.<NodeLogicEntity>ent().link != tile.pos());
    }
