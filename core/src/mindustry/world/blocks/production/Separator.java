...
public class Separator extends Block{
    ...
    public class SeparatorBuild extends Building{
        ...
        public void draw(){
            ...
            Drawf.liquid(liquidRegion, x, y, liquids.total() / liquidCapacity, liquids.current().color, drawRot());

            if(Core.atlas.isFound(spinnerRegion)){
                Draw.rect(spinnerRegion, x, y, totalProgress * spinnerSpeed + drawRot());
            }
        }
