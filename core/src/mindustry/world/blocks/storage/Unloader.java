        ...
        public void updateTile(){
            ...
            if(item != null){
                ...
                possibleBlocks.sort(Structs.comps(
                    Structs.comparingBool(e -> e.building.block instanceof StorageBlock || e.building instanceof StackConveyorBuild),
                ...
                //trade the items
                if(dumpingFrom != null && dumpingTo != null && (dumpingFrom.loadFactor != dumpingTo.loadFactor || (dumpingFrom.building instanceof StackConveyorBuild || dumpingFrom.building.block instanceof StorageBlock))){
