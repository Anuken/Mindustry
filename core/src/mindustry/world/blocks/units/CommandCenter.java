...
public class CommandCenter extends Block{
    ...
    public class CommandBuild extends Building{
        ...
        public void draw(){
            ...
            Draw.rect(commandRegions[team.data().command.ordinal()].getRegion(), x, y - 1, size, size, drawRot());
            Draw.color(topColor == null ? team.color : topColor);
            Draw.rect(commandRegions[team.data().command.ordinal()].getRegion(), x, y, size, size, drawRot());
            Draw.color();
        }
