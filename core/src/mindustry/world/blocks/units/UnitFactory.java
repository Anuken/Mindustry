...
public class UnitFactory extends UnitBlock{
    ...
    public class UnitFactoryBuild extends UnitBuild{
        ...
        public void buildConfiguration(Table table){
            ...
            if(units.any()){
                ItemSelection.buildTable(table, units, () -> currentPlan == -1 ? null : plans.get(currentPlan).unit, unit -> configure(plans.indexOf(u -> u.unit == unit)), selectionRows, selectionColumns);
            }else{
