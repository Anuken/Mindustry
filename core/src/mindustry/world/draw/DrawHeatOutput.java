...
public class DrawHeatOutput extends DrawBlock{
    ...
    public void draw(Building build){
        ...
        Draw.rect(((build.rotation + rotOffset) % 4) > 1 ? top2 : top1, build.x, build.y, rotdeg);
    ...
    public void drawPlan(Block block, BuildPlan plan, Eachable<BuildPlan> list){
        Draw.rect(((plan.rotation + rotOffset) % 4) > 1 ? top2 : top1, plan.drawx(), plan.drawy(), (plan.rotation + rotOffset) * 90);
    }
