...
public class UnitDrops {
    ...
    public static void init(){
        ...
        drops.put(UnitTypes.arkyid, ItemStack.with(Items.copper, 300, Items.graphite, 80, Items.metaglass, 80, Items.titanium, 80, Items.thorium, 20, Items.phase-fabric, 10));
        drops.put(UnitTypes.toxopid, ItemStack.with(Items.copper, 400, Items.lead, 400, Items.silicon, 120, Items.graphite, 120, Items.thorium, 40, Items.plastanium, 40, Items.phase-fabric, 5, Items.surge-alloy, 15));
        ...
        drops.put(UnitTypes.scepter, ItemStack.with(Items.copper, 300, Items.silicon, 80, Items.metaglass, 80, Items.titanium, 80, Items.thorium, 20, Items.phase-fabric, 10));
        drops.put(UnitTypes.reign, ItemStack.with(Items.copper, 400, Items.lead, 400, Items.silicon, 120, Items.graphite, 120, Items.thorium, 40, Items.plastanium, 40, Items.phase-fabric, 5, Items.surge-alloy, 15));
        ...
        drops.put(UnitTypes.vela, ItemStack.with(Items.copper, 300, Items.metaglass, 80, Items.graphite, 80, Items.titanium, 60, Items.plastanium, 20, Items.surge-alloy, 5));
        drops.put(UnitTypes.corvus, ItemStack.with(Items.copper, 400, Items.lead, 400, Items.silicon, 100, Items.metaglass, 120, Items.graphite, 100, Items.titanium, 120, Items.thorium, 60, Items.phase-fabric, 10, Items.surge-alloy, 10));
        ...
        drops.put(UnitTypes.antumbra, ItemStack.with(Items.copper, 300, Items.graphite, 80, Items.metaglass, 80, Items.titanium, 60, Items.surge-alloy, 15));
        drops.put(UnitTypes.eclipse, ItemStack.with(Items.copper, 400, Items.lead, 400, Items.silicon, 120, Items.graphite, 120, Items.titanium, 120, Items.thorium, 40, Items.plastanium, 40, Items.phase-fabric, 10, Items.surge-alloy, 5));
        ...
        drops.put(UnitTypes.quad, ItemStack.with(Items.copper, 300, Items.silicon, 80, Items.metaglass, 80, Items.titanium, 80, Items.thorium, 20, Items.phase-fabric, 10));
        drops.put(UnitTypes.oct, ItemStack.with(Items.copper, 400, Items.lead, 400, Items.silicon, 120, Items.graphite, 120, Items.thorium, 40, Items.plastanium, 40, Items.phase-fabric, 5, Items.surge-alloy, 15));
        ...
        drops.put(UnitTypes.sei, ItemStack.with(Items.copper, 300, Items.metaglass, 80, Items.graphite, 80, Items.titanium, 60, Items.plastanium, 20, Items.surge-alloy, 5));
        drops.put(UnitTypes.omura, ItemStack.with(Items.copper, 400, Items.lead, 400, Items.silicon, 100, Items.metaglass, 120, Items.graphite, 100, Items.titanium, 120, Items.thorium, 60, Items.phase-fabric, 10, Items.surge-alloy, 10));
        
        // Basic
        drops.put(UnitTypes.alpha, ItemStack.with(Item.copper, 30, Item.lead, 30, Item.silicon, 20, Item.graphite, 20, Item.metaglass, 20));
        drops.put(UnitTypes.beta, ItemStack.with(Item.titanium, 40, Item.thorium, 20));
        drops.put(UnitTypes.gamma, ItemStack.with(Item.plastanium, 20, Item.phase-fabric, 10, Item.surge-alloy, 10));
